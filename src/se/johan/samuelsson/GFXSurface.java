...
public class GFXSurface extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ourSurfaceView = new SorgSurface(this);
		...
		plus = BitmapFactory.decodeResource(getResources(), R.drawable.green_plus);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		//PROCESS SPEED FIX FOR BETTER FPS ON BAD DEVICES
		try {
			Thread.sleep(50);
	...
	public class SorgSurface extends SurfaceView  implements Runnable{
		
		SurfaceHolder ourHolder;
		Thread ourThread = null;
		boolean isRunning = false;

		public SorgSurface(Context context) {
			super(context);
			ourHolder = getHolder();
		}
